/// @description  TweenFireTo(target,ease,mode,delta,delay,dur,prop,to,[...])
/// @param target
/// @param ease
/// @param mode
/// @param delta
...
function TweenFireTo() {
	...
	/*
	    ...
	    Examples:
	        ...
	        TweenFireTo(id, EaseInQuad, TWEEN_MODE_ONCE, true, 0.0, 1.0, "x", x, Mxd);
        
	        // Ease "x" and "y" values to (Mxd, Myd) over 60 steps with a 30 step delay.
