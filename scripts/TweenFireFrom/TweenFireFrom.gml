/// @description  TweenFireFrom(target,ease,mode,delta,delay,dur,prop,from,[...])
/// @param target
/// @param ease
/// @param mode
/// @param delta
...
function TweenFireFrom() {
	...
	/*
	    ...
	    Examples:
	        // Ease "x" value from (Mxd), over 1 second
	        TweenFireFrom(id, EaseInQuad, TWEEN_MODE_ONCE, true, 0.0, 1.0, "x", Mxd);
        
	        // Ease "x" and "y" values from (Mxd, Myd) over 60 steps with a 30 step delay.
