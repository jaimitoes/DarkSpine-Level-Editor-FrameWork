/// @description  TweenSet(tween[s],dataLabel,value[,...])
/// @param tween[s]
/// @param dataLabel
/// @param value[
/// @param ...]
	...
	/*
	    ...
	    // values in the same order the properties were first assigned: 
	        ...
	        e.g.
	            ...
	            TweenSet(tween, "start", Mxd, Myd); // update to x/y mouse coordinates
           
	    // The keyword [undefined] can be used to leave a property value unchanged
	        e.g.
	            TweenSet(tween, "start", undefined, Myd); // update "y" but leave "x" unchanged
	*/
