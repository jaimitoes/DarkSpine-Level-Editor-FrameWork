/// @description dks_draw_button_array(Button array2D,text array2d)
/// @param Button array2D
/// @param text array2d
function dks_draw_button_array(argument0, argument1) 
{
	var b = argument0;
	var l = argument1;
	...
	for (var i =0; i<s;i++)
	{
	 if point_in_rectangle(device_mouse_x_to_gui(0),device_mouse_y_to_gui(0),b[i][0], b[i][1], b[i][2], b[i][3])
	 {
	  ...
	  draw_text(b[i][0]+b[i][4],b[i][1]+b[i][5],l[ i][10]);
