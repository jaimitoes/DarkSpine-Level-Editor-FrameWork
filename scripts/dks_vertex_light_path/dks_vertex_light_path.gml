/// @description dks_vertex_light_path(texture,image_index,color,alpha,terrain texture split, v-split,segments mult,corner left, corner right);
/// @param texture
/// @param image_index
/// @param color
/// @param alpha
...
/// @param corner left
/// @param  corner right
///Creates a custom light buffer texture that can be managed like a regular texture
function dks_vertex_light_path(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) 
{
 ...
 var size = ds_list_size(pl) div 2;
  ...
  pp[0][0] = x1;
	 pp[0][1] = y1;
	 /////////////////////////////  
	 pp[1][0] = bx1;//los dos controladores...
	 pp[1][1] = by1;
  ...
  if (i =0) and (l_corner > 0)
	 {
	  ...
	  scr_vertex_add_point(buffer_path,px, py,zd,uv_left,uv_down-0.25,c_black,0);
		 scr_vertex_add_point(buffer_path,xx3,yy3,zd,uv_right,uv_up,c_black,0);
		 scr_vertex_add_point(buffer_path,xx1,yy1,zd,uv_left,uv_up,c_black,0);
 
	  scr_vertex_add_point(buffer_path,px2, py2,zd,uv_right,uv_down-0.25,color,alpha);
		 scr_vertex_add_point(buffer_path,xx3,yy3,zd,uv_right,uv_up,c_black,0);
		 scr_vertex_add_point(buffer_path,px, py,zd,uv_left,uv_down-0.25,c_black,0);
 
	  scr_vertex_add_point(buffer_path,xx2,yy2,zd,uv_left,uv_down,c_black,0);
		 scr_vertex_add_point(buffer_path,px2, py2,zd,uv_right,uv_down-0.25,color,alpha);
		 scr_vertex_add_point(buffer_path,px, py,zd,uv_left,uv_down-0.25,c_black,0);
			
   scr_vertex_add_point(buffer_path,xx4,yy4,zd,uv_right,uv_down,c_black,0);
	  scr_vertex_add_point(buffer_path,px2, py2,zd,uv_right,uv_down-0.25,color,alpha);
	  scr_vertex_add_point(buffer_path,xx2,yy2,zd,uv_left,uv_down,c_black,0);
 ...
 scr_vertex_add_point(buffer_path,px2, py2,zd,uv_right,uv_down-0.25,c_black,0);
	scr_vertex_add_point(buffer_path,xx3,yy3,zd,uv_right,uv_up,c_black,0);
	scr_vertex_add_point(buffer_path,px, py,zd,uv_left,uv_down-0.25,color,alpha);
