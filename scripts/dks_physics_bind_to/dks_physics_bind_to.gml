/// @description dks_physics_bind_to(bind_target, bind_xoffset, bind_yoffset)
/// @param bind_target
/// @param  bind_xoffset
/// @param  bind_yoffset
function dks_physics_bind_to(argument0, argument1, argument2) 
{
	var mtp=argument0.mtx;
	var xoff = argument1; 
	var yoff = argument2;
	phy_position_x =  xoff*mtp[0] + -yoff*mtp[1] +mtp[12]*1;
	phy_position_y = -xoff*mtp[4] +  yoff*mtp[5] +mtp[13]*1;
	...
	phy_rotation = -(anoff+(argument0.image_angle-argument0.anoff));
