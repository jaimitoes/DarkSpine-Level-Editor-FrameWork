/// @description  TweenAddCallback(tween,event,target,script,[arg0...])
/// @param tween
/// @param event
/// @param target
/// @param script
...
function TweenAddCallback() {
	...
	/// @param tweentween id
	/// @param eventtween event macro (TWEEN_EV_*)
	/// @param targetinstance used to call script
	/// @param scriptscript to call on tween event
	...
	*/
	...
	repeat(_index-4)
	{
		...
		{
	     _cb[_index] = dks_array_copy(argument[_index]);
		}
		else
		{
