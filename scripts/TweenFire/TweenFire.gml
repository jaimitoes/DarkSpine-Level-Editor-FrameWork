/// @description  TweenFire(target,ease,mode,delta,delay,dur,prop,start,dest,[...])
/// @param target
/// @param ease
/// @param mode
/// @param delta
...
function TweenFire() {
	...
	/*
	    ...
	    Examples:
	        // Ease "x" value from (x) to (Mxd), over 1 second
	        TweenFire(id, EaseInQuad, TWEEN_MODE_ONCE, true, 0.0, 1.0, "x", x, Mxd);
        
	        // Ease "x" and "y" values from (x, y) to (Mxd, Myd) over 60 steps with a 30 step delay.
	        // Tween will play back and forth, repeatedly.
	        TweenFire(obj_Player, EaseOutCubic, TWEEN_MODE_PATROL, false, 30, 60, x__, x, Mxd, y__, y, Myd);
